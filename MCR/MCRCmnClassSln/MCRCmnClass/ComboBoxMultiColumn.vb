...
Public Class ComboBoxMultiColumn
    ...
    Dim m_BackColorFocus As Color = Color.White
    ...
    Protected Overrides Sub OnKeyDown(ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        MyBase.OnKeyDown(e)
    End Sub
    <Category("My Property"), DefaultValue(GetType(Color), "Beige"), Description("Color when you got focus.")> _
Public Property BackColorFocus() As Color
        ...
        End Set
    End Property
    Private Sub MultiColumnCombo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
        oldColor = Me.BackColor
        Me.BackColor = m_BackColorFocus
    End Sub

    Private Sub MultiColumnCombo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.LostFocus
