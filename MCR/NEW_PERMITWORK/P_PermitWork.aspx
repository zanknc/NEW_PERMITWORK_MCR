<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="P_PermitWork.aspx.vb" Inherits="P_PermitWork" %>
    ...
    <div align="center">
        <table class="table-condensed">
            <tr>
                ...
                <Header><h3 align="center">ใบอนุญาตให้ทำงาน (Permit To Work)</h3></Header>
                </th>  
            </tr>
        </table>
            <hr />
...
<div style="width: 1000px;"  >
                        ...
                        <div align="center">
                            <table class="table-condensed">
                                <tr>
                                    ...
                                    <th>เลขที่</th>
                                    <th>
                                        <asp:TextBox ID="txtcheckno" runat="server" CssClass="form-control" placeholder="กรุณาใส่ WorkPermit No"></asp:TextBox>
                ...
                <Header><h4 align="left">ผู้ขออนุญาตและผู้ควบคุม</h4></Header>
                     <Content>
                       ...
                       <table class="table-condensed">
                            <tr>
                                <th>ผู้ขออนุญาต</th>
                                <th><asp:TextBox ID="txtAApplicant" runat="server"  CssClass=" form-control" placeholder="กรุณาใส่เฉพาะชื่อ"></asp:TextBox></th> 
                                <th>เบอร์โทรศัพท์มือถือ</th>
                                <td><asp:TextBox ID="txt_tel_mobile" runat="server"  CssClass=" form-control" placeholder="เบอร์โทรศัพท์มือถือ"></asp:TextBox></td>
                                <th>เบอร์ภายในหน่วยงาน</th>
                                <td><asp:TextBox ID="txt_tel_in_company" runat="server"  CssClass=" form-control" placeholder="เบอร์ภายในหน่วยงาน"></asp:TextBox></td>
                            </tr>
                          ...
                          <tr>
                                <th>ผู้ควบคุม</th>
                                <th>
                                <asp:TextBox ID="txtControl" runat="server"  CssClass=" form-control" placeholder="กรุณาใส่เฉพาะชื่อ"></asp:TextBox>
                                </th>
                                <th>อีเมล์ภายในบริษัท</th>
                                <th>
                                <asp:TextBox ID="txtControlEmail" runat="server"  CssClass=" form-control text-lowercase" placeholder="กรุณาใส่อีเมล์ภายในบริษัท" ></asp:TextBox>
                                    
                                </th>
                                <th></th>

                             <asp:AutoCompleteExtender ServiceMethod="SearchEMAIL"
    MinimumPrefixLength="1"
    CompletionInterval="100" EnableCaching="false" CompletionSetCount="10"
    TargetControlID="txtControlEmail"
    ID="AutoCompleteExtender2" runat="server" FirstRowSelected = "false">
               ...
               <asp:AccordionPane ID="Accordion_Mail" runat="server" ContentCssClass="contentclass" HeaderCssClass="accordionHeader">
                <Header><h4 align="left">Send Mail To Fac</h4></Header>
                     <Content>
                        <hr />
                       <table class="table-condensed">
        ...
        <tr>
            ...
            <td>
                <%--<asp:Button ID="Button1" Text="Send"  runat="server" />--%>
            </td>
        </tr>
                ...
                <asp:AccordionPane ID="AccordionPane1" runat="server" ContentCssClass="contentclass" HeaderCssClass="accordionHeader">
                    ...
                    <Content>
                        ...
                        <table class="table-condensed">
                            ...
                            <tr>
                                <th><asp:CheckBox ID="CHK_Work_others" runat="server" Text="งานอื่นๆ ระบุ" class="checkbox-inline " AutoPostBack="true"  /></th>
                                <th colspan="3"><asp:TextBox ID="txtWorkother" runat="server"  CssClass=" form-control " Enabled="false"></asp:TextBox></th>
                                <th ></th>
                        ...
                        <table class="table-condensed">
                            ...
                            <tr>
                                ...
                                <th><asp:TextBox ID="tb_date_wk" runat="server"  CssClass=" form-control" placeholder="กรุณาเลือกวันที่"></asp:TextBox></th>
                            ...
                            <tr>
                                ...
                                <th colspan="5"><asp:TextBox ID="txtDetailWork" runat="server"  CssClass=" form-control"  placeholder="กรุณากรอกรายละเอียดด้วยนะครับ"></asp:TextBox></th>
                        ...
                        <table class="table-condensed">
                            <tr>
                                ...
                                <th>ฝ่าย:</th>
                                <th>
                                    <asp:DropDownList ID="ddldivion" runat="server" CssClass=" form-control " Enabled="false" AutoPostBack="true"  >
                                    </asp:DropDownList>
                                </th>
                                <th>แผนก:</th>
                                <th>
                                    <asp:DropDownList ID="ddldepartment" runat="server" CssClass=" form-control " Enabled="false">
                                    </asp:DropDownList>
                                </th>
                            ...
                            <tr>
                                ...
                                <th>บริษัท :</th>
                                <th colspan="3"> <asp:TextBox ID="txtSearch" runat="server"  CssClass="form-control" Enabled="false" placeholder="กรุณากรอกชื่อบริษัทผู้รับเหมา" ></asp:TextBox></th>
                     <asp:AutoCompleteExtender ServiceMethod="SearchVendor"
    MinimumPrefixLength="1"
    CompletionInterval="100" EnableCaching="false" CompletionSetCount="10"
    ...
    ID="AutoCompleteExtender1" runat="server" FirstRowSelected = "false">
                            ...
                            <tr>
                                ...
                                <th></th>
                                <th>ชื่อ :</th>
                                <th><asp:TextBox ID="txtname" runat="server" CssClass="form-control" Enabled="false" placeholder="กรุณากรอกชื่อของผู้รับเหมา"></asp:TextBox></th>
                                <th>ลูกทีม</th>
                                <th><asp:TextBox ID="txtsumname" runat="server" CssClass="form-control" Enabled="false" placeholder="กรุณากรอกจำนวนลูกทีม"></asp:TextBox></th>
                            </tr>
                        </table>
 </Content>
                </asp:AccordionPane>
                  <asp:AccordionPane ID="AccordionPane6" runat="server" ContentCssClass="contentclass" HeaderCssClass="accordionHeader">
                    <Header><h4 align="left">ตรวจสอบความเกี่ยวข้องกับระบบแจ้งเหตุเพลิงไหม้ (Fire Alarm System)</h4></Header>
                    <Content>
                        <hr />
                        <table class="table-condensed">
                          
                      <tr>
                                <th>งานที่ทำเกี่ยวข้องกับระบบแจ้งเหตุเพลิงไหม้</th>
                                    <th>
                                        <asp:CheckBoxList ID="AlertFire" runat="server" CssClass="mycheckbox" RepeatDirection="Horizontal" >
                          ...
                          <tr>
                                ...
                                <th colspan="4">
                                <asp:TextBox ID="txtMoreDetail" runat="server"  CssClass=" form-control"></asp:TextBox>
                                </th>
                ...
                <asp:AccordionPane ID="AccordionPane2" runat="server" ContentCssClass="contentclass" HeaderCssClass="accordionHeader">
                    ...
                    <Content>
                        ...
                        <table class="table-condensed">
                            ...
                            <tr>
                                <th><asp:CheckBox ID="CHK_Other" runat="server" Text="งานอื่นๆ ระบุ" class="checkbox-inline "  AutoPostBack="true" /></th>
                                <th  colspan="3"><asp:TextBox ID="txtCHK_Detail" runat="server"  CssClass=" form-control   "  Enabled="false"></asp:TextBox></th>
                    ...
                    <Content>
                        ...
                        <table class="table-condensed">
                            ...
                            <tr>
                                ...
                                <th><asp:CheckBox ID="CHK_OtherEquipment" runat="server" Text="อื่นๆ ระบุ" class="checkbox-inline "  AutoPostBack="true"/></th>
        ...
        <div>
            <table class="table-condensed">
                <tr>
                    <th><asp:Button ID="BtnSave" runat="server" CssClass="btn btn-primary" Text="บันทึกข้อมูล" /></th>
                    <th><asp:Button ID="BtnUpdate" runat="server" CssClass="btn btn-primary" Text="แก้ไขข้อมูล" Visible="false" /></th>
                </tr>
            </table>
        </div>
