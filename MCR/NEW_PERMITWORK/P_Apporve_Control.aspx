...
<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="P_Apporve_Control.aspx.vb" Inherits="P_Apporve_Control" %>
...
<table class="table-condensed">
            <tr>
                ...
                <Header><h3 align="center">CONTROLLER APPORVE</h3></Header>
                </th>  
            </tr>
        </table>
<hr />  
                    ...
                    <Content>
                        ...
                        <table class="table-condensed">
                            <tr>
                                ...
                                <th><asp:CheckBox ID="CHK_Chemical_Gloves" runat="server" Text="หน้ากากป้องกันสารเคมี" class="checkbox-inline"  /></th>
                                
                            </tr>
                            <tr>
                                <th><asp:CheckBox ID="CHK_Helmet" runat="server" Text="ถุงมือกันสารเคมี" class="checkbox-inline"  /></th>
                                <th><asp:CheckBox ID="CHK_Safety_glasses_dimming" runat="server" Text="แว่นตานิรภัย,ลดเสียง" class="checkbox-inline"  /></th>
                                <th><asp:CheckBox ID="CHK_Respirator" runat="server" Text="หมวกนิรภัย" class="checkbox-inline"  /></th>
...
<div>
  ...
  <asp:GridView ID="GridView3" runat="server" BackColor="White"  ShowHeaderWhenEmpty="false"
        BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="table table-bordered table-hover table-responsive " 
        CellPadding="3"  AutoGenerateColumns="False">
        <RowStyle ForeColor="#000066" />
        <FooterStyle BackColor="White" ForeColor="#000066" />
