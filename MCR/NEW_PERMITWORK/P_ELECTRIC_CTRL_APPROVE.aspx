<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="P_ELECTRIC_CTRL_APPROVE.aspx.vb" Inherits="P_ELECTRIC_CTRL_APPROVE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container-fluid">
        <div class="well">  
            <h2 class="text-danger">Electrical Control Work Approve</h2>  
            <span class="text-info">This Step for Controller Work Approve </span>  
            <hr/>
            <div class="table-responsive">
                <asp:GridView ID="gvctrlapp" runat="server" Width="100%" CssClass="table table-bordered success " AutoGenerateColumns="False" EmptyDataText="There are no data records to display.">
                    <Columns>
            ...
            <asp:LinkButton ID="lnkctrlapprove" runat="server" CssClass="btn btn-success fa fa-check">Approve</asp:LinkButton>
          
        </div> 
        
        <div class="table-responsive" style="display: none">
            <asp:GridView ID="gvhostarea" runat="server" Width="100%" CssClass="table table-bordered success" BackColor="White"
