...
#Region "Event"
    ...
    Private Sub SEMIStopLot_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        Try
    ...
    Private Sub SEMIStopLot_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
    ...
    Private Sub SEMIStopLot_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub SEMIStopLot_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
        Try
    ...
    Private Sub SEMIStopLot_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            GetDefault()
            ResetAll()
        Catch ex As Exception
...
#Region "Private Function"
    ...
    Private Sub GetDefault()
        Try
            Me.Title = Me.GetPurposeVal("TITL", "7005")
        ...
        Try
            ...
            Try
                ...
                Else
                    ...
                    Next
                End If
                cntRec = objCtrSEMI.CheckSEMIStopLot(objTran)
                objTran.Commit()
    ...
    Private Function RunStopLot(ByVal StatusCode As String, ByVal AbMode As String, _
        ...
        Try
            ...
            Try
                cntRec = objCtrSEMI.RunSEMIStopLot(StatusCode, AbMode, Reason, ProcessCode, objTran)
                If cntRec <= 0 Then 'RETURN RECORD UPDATE
                    objTran.Rollback()
                    MyBase.IsErrMsg = True
                    MyBase.Message = Me.GetPurposeVal("MESG", "7106")
                Else
                    objTran.Commit()
                    ...
                    Finally
                        ...
                        MyBase.Message = Me.GetPurposeVal("MESG", "7109")
                    End Try
    ...
    Private Function RunStopLotStatusLot(ByVal OPID As String, ByVal StatusCode As String, ByVal Flag As Integer) As Integer
        ...
        Try
            ...
            cntRec = objCtrMainten.UpdateStatusLotSemi(OPID, StatusCode, Flag)
